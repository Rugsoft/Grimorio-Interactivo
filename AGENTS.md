...
└── 10-clan-adhesion-ceremony.spec.md    # Vestíbulo de las Hermandades: adhesión a clanes del propio linaje (enmienda SPEC-07; tríada canónica completa — spec, plan y tasks)
