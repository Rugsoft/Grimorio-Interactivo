...
| :--- | :--- | :--- |
| **RF-01.1 - RF-01.3** (Estados e Inmutabilidad) | `SpellReviewRepository`, `ModerationWorkflowService` | `testSpellReviewStateTransitions()` |
